 ...
 */
function HTMLCov(e){var t=require("jade"),i=__dirname+"/templates/coverage.jade",r=fs.readFileSync(i,"utf8"),n=t.compile(r,{filename:i}),s=this;JSONCov.call(this,e,!1),e.on("end",function(){process.stdout.write(n({cov:s.cov,coverageClass:coverageClass}))})}function coverageClass(e){return e>=75?"high":e>=50?"medium":e>=25?"low":"terrible"}var JSONCov=require("./json-cov"),fs=require("fs");exports=module.exports=HTMLCov;